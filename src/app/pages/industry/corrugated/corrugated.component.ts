...
export class CorrugatedComponent {
  config: IndustryPageConfig = {
    badge: 'Packaging Industry ERP', heroTitle: 'Corrugated', heroTitleHighlight: 'Box ERP',
    ...
    heroCta: 'Pack Smarter', heroImage: 'https://images.unsplash.com/photo-1553413077-190dd305871c?auto=format&fit=crop&q=80&w=1000',
