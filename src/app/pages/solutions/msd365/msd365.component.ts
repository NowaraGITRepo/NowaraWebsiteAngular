...
export class Msd365Component implements OnInit {
  private seo = inject(SeoService);
  ngOnInit() { this.seo.setPage(SEO.msd365.title, SEO.msd365.description); }
  config: IndustryPageConfig = {
    badge: 'Business Applications', heroTitle: 'Finance &', heroTitleHighlight: 'Operations',
    ...
    heroCta: 'Explore F&O', heroImage: '/images/product/finance-operation.webp',
